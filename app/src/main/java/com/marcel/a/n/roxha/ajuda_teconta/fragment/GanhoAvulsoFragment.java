...
import com.marcel.a.n.roxha.ajuda_teconta.activity.GanhosActivity;
 ...
 * Use the {@link GanhoAvulsoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GanhoAvulsoFragment extends Fragment {
     ...
     * @return A new instance of fragment GanhoAvulsoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GanhoAvulsoFragment newInstance(String param1, String param2) {
        GanhoAvulsoFragment fragment = new GanhoAvulsoFragment();
    ...
    private Button botao_salvar_ganho_avulso;
    private Button botao_voltar_ganho_avulso;
    private CalendarView calendario_ganho_avulso;
    private TextInputEditText nome_ganho_avulso;
    private TextInputEditText valor_ganho_avulso;
    private TextView texto_data_prevista_ganho_avulso;
    private double valorConvertGanhoAvulso;
    private String data_ganho_avulso;
    private int mes_referencia;

    private List<String> list_data_ganho_avulso = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ganhos_avulsos, container, false);

        botao_salvar_ganho_avulso = view.findViewById(R.id.botao_salvar_ganho_avulso_id);
        botao_voltar_ganho_avulso = view.findViewById(R.id.botao_voltar_ganho_avulso);
        calendario_ganho_avulso = view.findViewById(R.id.calendario_ganho_avulso_id);
        nome_ganho_avulso = view.findViewById(R.id.nome_ganho_avulso_id);
        valor_ganho_avulso = view.findViewById(R.id.valor_ganho_avulso_id);

        texto_data_prevista_ganho_avulso = view.findViewById(R.id.texto_data_ganho_avulso_id);

        calendario_ganho_avulso.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            @Override
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int i, int i1, int i2) {

                data_ganho_avulso = i2 + "/" + i1 + "/" + i;
                mes_referencia = i1;


                texto_data_prevista_ganho_avulso.setText("Data prevista do ganho avulso é: " + data_ganho_avulso);
        ...
        botao_salvar_ganho_avulso.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String nome_gasto_digitado = nome_ganho_avulso.getText().toString();
                String valor_gasto_digitado = valor_ganho_avulso.getText().toString();
        ...
        FirebaseFirestore.getInstance().collection("MONTANTES_MENSAIS")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        double calcularMontanteGanhos = gastoExistente + valorConvertido;

                        gastoAtualizar.setValor_total__ganhos_mes_referencia(calcularMontanteGanhos);
    ...
    public void salvarGastoAvulsoMontante(GastoModel gastoModelRecuperado){
        ...
        CollectionReference referenceGastoAvulso = db.collection("MONTANTES_MENSAIS").document(getIdRecuperado()).collection("GANHOS_AVULSOS");
